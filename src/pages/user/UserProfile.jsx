...
function UserProfile() {
  ...
  const updateAuthInfo = useSetAtom(authAtom);
        ...
        <CardBody className="p-4 sm:p-5 md:p-6">
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-5">
            ...
            <div className="relative group shrink-0">
              <div className="relative w-28 h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 rounded-full overflow-hidden border-2 border-white dark:border-gray-800 shadow-lg ring-2 ring-gray-100 dark:ring-gray-700">
                <img
              ...
              <button
                ...
                disabled={uploading}
                className="absolute bottom-0 right-0 sm:bottom-1 sm:right-1 bg-primary text-white rounded-full p-2 sm:p-2.5 shadow-lg hover:bg-primary-600 hover:scale-110 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100 ring-2 ring-white dark:ring-gray-800 cursor-pointer"
            ...
            <div className="flex-1 text-center sm:text-left w-full min-w-0">
              <div className="mb-2 sm:mb-3">
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-2 sm:gap-3">
                  ...
                  {/* Right Side: Verification Status & Address Book - Desktop */}
              ...
              <div className="grid grid-cols-2 gap-2 sm:hidden mb-3">
                ...
                <Link to="/user/address-book" className="col-span-2">
                  <div className="flex flex-col items-center gap-1 p-2 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors">
                    <FaMapMarkerAlt className="w-3.5 h-3.5 text-purple-600 dark:text-purple-400 shrink-0" />
                    <div className="text-center min-w-0 w-full">
                      <p className="text-[10px] text-gray-500 dark:text-gray-400 font-medium mb-0.5">
                        Address Book
                      </p>
              ...
              <div className="hidden sm:block">
                ...
                <Link to="/user/address-book">
                  <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-purple-100 dark:bg-purple-900/30 border border-purple-200 dark:border-purple-800 hover:bg-purple-200 dark:hover:bg-purple-900/50 transition-colors cursor-pointer">
                    <FaMapMarkerAlt className="w-4 h-4 text-purple-600 dark:text-purple-400 shrink-0" />
                    <span className="text-xs sm:text-sm font-medium text-purple-700 dark:text-purple-300 whitespace-nowrap">
                      Address Book
                    </span>
                  </div>
                </Link>
        ...
        <CardBody className="pt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            <Link to="/user/shopping-cart">
              <Card
                shadow="md"
                className="bg-linear-to-br from-blue-500 to-blue-600 text-white border-0 overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer"
              >
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-xs opacity-80 mt-1">
                        {user.cartItemCount === 1 ? "item" : "items"}
                      </p>
                    </div>
            ...
            <Link to="/user/orders">
              <Card
                shadow="md"
                className="bg-linear-to-br from-green-500 to-green-600 text-white border-0 overflow-hidden hover:shadow-lg transition-all duration-300 hover:scale-[1.02] cursor-pointer"
              >
                <CardBody className="p-4 sm:p-5">
                  <div className="flex items-center justify-between">
                    <div>
        ...
        <CardBody className="pt-0">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-5">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-3 p-3 sm:p-4 bg-gray-50 dark:bg-gray-800/50 rounded-lg border border-gray-200 dark:border-gray-700 hover:border-primary/30 dark:hover:border-primary/30 transition-colors">
                <div className="p-2 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 shrink-0">
                  <FaEdit className="w-4 h-4 text-indigo-600 dark:text-indigo-400" />
                </div>
                <span className="text-sm sm:text-base text-gray-900 dark:text-white font-medium">
